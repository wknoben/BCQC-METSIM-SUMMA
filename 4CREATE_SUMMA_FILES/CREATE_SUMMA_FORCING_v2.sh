...
###########################################
os.chdir('/Users/cjh458/Desktop/BCQC-METSIM-SUMMA/4CREATE_SUMMA_FILES/LISTS')						# Change directory into the folder containing lists of names
...
#######################################
datastep_varid = ncid.createVariable('data_step','f')		# Create data_step variable in the new datafile
...
for z in range(data_length):											      # Iterate through snotel sites
	...
	wind_varid[0:time_len,z] = wind_data[0:time_len]*(0.4)/np.log(10/2) # Stull conversion -- Frictional velocity  # Assign ERA5 data to file
