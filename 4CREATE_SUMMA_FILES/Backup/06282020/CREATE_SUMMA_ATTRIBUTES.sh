...
#######################################
os.chdir('/Users/cjh458/Desktop/BCQC-METSIM-SUMMA/4CREATE_SUMMA_FILES/LISTS')							# Change directory into the folder containing list data
...
hruid = data['hru_id'].values[:]						# Extract an snotel id variable from this file
...
os.chdir('/Users/cjh458/Desktop/BCQC-METSIM-SUMMA/4CREATE_SUMMA_FILES/OUTPUT/')							# Change directory into the output folder
...
dimid_gru = ncid.createDimension('gru', data_length)						# Declare geographical response unit dimension of 1
...
# Assign variable  value
for z in range(data_length):												# loop through the snotel sites
	elevation_varid[z]=elevation[z]/3.281									# Assign variable a value from the snoTEL information .csv
...
# Declare attributes for the new variable 				
latitude_varid.long_name      = 'Latitude of HRUs centriod point'
...
# Declare attributes for the new variable 				
longitude_varid.long_name      = 'longitude of HRUs centriod point'
...
for z in range(data_length):												# loop through the snotel sites
	vegTypeIndex_varid[z] = 10 #vti_data[hruid[z]]						# assign new variable existing value for the HRU
...
for z in range(data_length):												# loop through the snotel sites
	soilti_varid[z] = 2 #soilti_data[hruid[z]]							# assign new variable existing value for the HRU
